  ...
  if (temperatures.length === 0) {
    return (
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="text-gray-500">No temperature sensors available</div>
      </div>
    );
  }
    ...
    <div className="bg-white rounded-lg shadow p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg p-4">
          <div className="text-sm text-gray-600 mb-1">Sensors</div>
          <div className="text-2xl font-bold text-gray-800">{temperatures.length}</div>
        </div>
      </div>
          ...
          return (
            <div key={index} className="border-l-4 border-gray-200 pl-3">
              <div className="flex items-center justify-between mb-1">
                <div>
                  <div className="text-sm font-medium text-gray-700">{temp.label}</div>
                  <div className="text-xs text-gray-500">{temp.sensor}</div>
                </div>
        ...
        <div className="flex items-center justify-between text-xs">
          <div className="flex items-center space-x-4">
            <div className="flex items-center">
              ...
              <span className="text-gray-600">Normal (&lt;60°C)</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-yellow-500 rounded-full mr-1" />
              <span className="text-gray-600">Warm (60-70°C)</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-orange-500 rounded-full mr-1" />
              <span className="text-gray-600">Hot (70-80°C)</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-red-500 rounded-full mr-1" />
              <span className="text-gray-600">Critical (&gt;80°C)</span>
            </div>
          </div>
        </div>
      </div>
